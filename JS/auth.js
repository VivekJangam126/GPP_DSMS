document.addEventListener('DOMContentLoaded', () => {
    ...
    // Login submit (simple demo / replace with API)
    loginForm?.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showFormMessage(loginError, data.message || 'Login failed');
        } catch (err) {
            // fallback: simulate success for demo
            // remove below block in production
            console.warn('Login API unavailable, simulating success.');
    ...
    registerForm?.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                showFormMessage(registerError, data.message || 'Registration failed');
            }
        } catch (err) {
            // fallback simulation for dev: succeed after delay
            console.warn('Register API unavailable, simulating success.');
